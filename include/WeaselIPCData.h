...
struct CandidateInfo {
  ...
  // scroll mode runtime state (not serialized)
  bool scroll_expanded;
  int scroll_row;
  int scroll_col;
};
...
struct UIStyle {
  ...
  int prevpage_color;
  int nextpage_color;
  // scroll mode row highlight color
  int scroll_row_back_color;
  int scroll_row_hilited_candidate_back_color;
  // per client
  int client_caps;
  int baseline;
  int linespacing;
  ...
  bool scroll_mode;
  int scroll_mode_initial_lines;
  int scroll_mode_max_lines;
  ...
  UIStyle()
      : font_face(),
        ...
        prevpage_color(0),
        nextpage_color(0),
        scroll_row_back_color(0),
        scroll_row_hilited_candidate_back_color(0),
        baseline(0),
        linespacing(0),
        scroll_mode(false),
        scroll_mode_initial_lines(1),
        scroll_mode_max_lines(4),
        client_caps(0) {}
  bool operator!=(const UIStyle& st) {
    return (
        ...
        scroll_row_back_color != st.scroll_row_back_color ||
        scroll_row_hilited_candidate_back_color != st.scroll_row_hilited_candidate_back_color ||
        scroll_mode != st.scroll_mode ||
        scroll_mode_initial_lines != st.scroll_mode_initial_lines ||
        scroll_mode_max_lines != st.scroll_mode_max_lines);
  }
};
}  // namespace weasel
namespace boost {
...
void serialize(Archive& ar, weasel::UIStyle& s, const unsigned int version) {
  ...
  // scroll mode
  ar & s.scroll_mode;
  ar & s.scroll_mode_initial_lines;
  ar & s.scroll_mode_max_lines;
  ar & s.scroll_row_back_color;
  ar & s.scroll_row_hilited_candidate_back_color;
}
